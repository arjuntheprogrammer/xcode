                ...
                if let followers = objects{
                    ...
                    for object in followers{
                        ...
                        if let follower = object as? PFObject{
                            ...
                            query.whereKey("useiId", equalTo: followedUser)
                            query.findObjectsInBackground(block: { (objects, error) in
                                if let posts = objects{
                                    ...
                                    for post in posts{
                                      ...
                                      //  self.users.value(forKey: <#T##String#>)
                                            self.messages.append(post["message"] as! String)
                                            self.imageFiles.append(post["imageFile"] as! PFFile)
                                            let id = post["useiId"] as! String
                                            //var usern = self.users[id]
                                        self.usernames.append(self.users.value(forKey: id) as! String)
